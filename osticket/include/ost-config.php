...
define('SECRET_SALT','sjWcrnIWr30BlOfkqYJwLVwRoRRZ8iMN');

#Default admin email. Used only on db connection issues and related alerts.
define('ADMIN_EMAIL','vasu.jain@live.in');

#Mysql Login info
define('DBTYPE','mysql');
define('DBHOST','mysql.sewafs.org');
define('DBNAME','bay_area_family_services');
define('DBUSER','sewafs');
define('DBPASS','vr12@SEWA');
