  ...
  <div class="row-fluid">
        ...
        <!-- Our Services -->
            ...
            <form class="span9" method="POST" action="page_volunteer_registration_process.php">
                    ...
                    ?>
                      <div><span class="alert-error" id="errorMessage"> </span></div>
                      <div><span class="alert-error" id="invalidEmailID"> </span></div>
                      <div><span class="alert-error" id="invalidPhoneNumber"> </span></div>
                      <div class="headline"><h4>Contact Information</h4> <span class="color-red">*</span></div>
                      <div class="vol-page">
                      <table >
                          <tr>
                            <td >
                                ...
                                <input class="input-medium required" type="text" id = "firstName" name= "firstName" placeholder="First Name">
                            ...
                            <td>
                                <div class="input-prepend">
                                <span class="add-on"><i class="icon-user"></i></span>
                                <input class="input-medium required" type="text" id = "lastName" name= "lastName" placeholder="Last Name">
                                </div>
                            </td>
                          </tr>
                          <tr>
                            <td >
                                ...
                                <input class="input-medium required" type="text" id = "emailID" name= "emailID" placeholder="Email ID">
                                </div>
                            </td>
                            <td>
                                <div class="input-prepend">
                                <span class="add-on"><i class="icon-phone"></i></span>
                                <input class="input-medium required phoneno" type="text" id = "phoneNo" name= "phoneNo" placeholder="Phone Number">
                                </div>
                            </td>
                            <td>
                    ...
                    <div class="vol-page">
                      <table>
                               ...
                               <td><input type="text" name="userName" class="input-xlarge" placeholder ="Name you want to show on the website"/></td>
